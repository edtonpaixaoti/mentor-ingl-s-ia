            ...
            <TabsContent value="magic" className="mt-6 space-y-4">
              {magicSent ? (
                ...
                <form onSubmit={handleMagic} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="magicEmail">E-mail</Label>
                    <Input id="magicEmail" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="voce@email.com" />
                  </div>
                  <Button type="submit" disabled={busy} className="w-full bg-gradient-primary">
